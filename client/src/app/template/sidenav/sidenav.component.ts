...
export class SidenavComponent implements OnInit{
  ...
  chatBotActivated: boolean = false;
  ...
  ngOnInit() {
    ...
    this.httpClient.get(environment.apiEndpoint + 'user/usernames', options).subscribe((result: any) => {
      try {
  ...
  public toggleChatBot() {
    this.chatBotActivated = !this.chatBotActivated;
  }
}